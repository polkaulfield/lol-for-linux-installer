...
dependencies="python3, python3-psutil, python3-pyqt5, wine-stable, python3-requests, qtbase5-dev, libgnutls30, libldap-dev, libpng16-16, libgphoto2-6, libpulse0, libqt5gui5, libc6"
