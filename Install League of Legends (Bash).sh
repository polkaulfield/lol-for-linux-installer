...
wine_lutris_ge_lol_url="https://github.com/GloriousEggroll/wine-ge-custom/releases/download/7.0-GE-8-LoL/wine-lutris-ge-lol-7.0.8-x86_64.tar.xz"  # Wine build URL
...
tar -xf "$downloads_dir/wine-lutris-ge-lol-7.0.8-x86_64.tar.xz" -C "$wine_dir" --strip-components=1
